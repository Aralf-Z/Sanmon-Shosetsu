...
namespace GameConsole.GameUI
{
    ...
    public class ConsolePanel : MonoBehaviour, IConsoleRenderer
    {
        [SerializeField] private Text outputPanel;
        [SerializeField] private InputField inputField;
        [SerializeField] private ConsolePanelOptions options;
        ...
        {
            get => options.gameObject.activeSelf;
            set => options.gameObject.SetActive(value);
        }
        public List<string> AlternativeOptions
        {
            set => options.SetOptions(value);
        }
        public int AlternativeOptionsIndex
        {
            set => options.SelectionIndex = value;
        }
